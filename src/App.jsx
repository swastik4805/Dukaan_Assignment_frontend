...
import { HamburgerMenu } from './coomponents/HamburgerMenu'
import { FullWidth } from './coomponents/FullWidth'
...
function App() {
  ...
  useEffect(()=>{
    const handleResize=()=>{
      setFullScreen(window.innerWidth>=1200);
    };
    handleResize();
  ...
  return (
    ...
    <div>
      {isFullScreen? (<div><FullWidth></FullWidth></div>):(
            <div>
                <Appbar></Appbar>
